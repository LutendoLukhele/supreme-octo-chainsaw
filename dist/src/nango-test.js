...
const NangoService_1 = require("../src/services/NangoService"); // Adjust path to your NangoService.ts
const config_1 = require("../src/config"); // Adjust path to your config.ts
// ========================================================================
...
config_1.CONFIG.CONNECTION_ID = TEST_CONFIG.CONNECTION_ID;
config_1.CONFIG.NANGO_SECRET_KEY = TEST_CONFIG.NANGO_SECRET_KEY;
// ========================================================================
// Test Runner
// ========================================================================
...
async function main() {
    ...
    if (config_1.CONFIG.CONNECTION_ID === 'a_real_connection_id' || config_1.CONFIG.NANGO_SECRET_KEY === 'sk_live_or_test_your_real_key') {
    ...
    try {
        ...
        const createResponse = await nangoService.triggerSalesforceAction('salesforce-2', config_1.CONFIG.CONNECTION_ID, 'create', 'Account', { name: uniqueAccountName, industry: 'Technology' });
        ...
        const fetchResponse = await nangoService.triggerSalesforceAction('salesforce-2', config_1.CONFIG.CONNECTION_ID, 'fetch', 'Account', testState.createdAccountId // Use the ID from the create step
        );
        ...
        const updateResponse = await nangoService.triggerSalesforceAction('salesforce-2', config_1.CONFIG.CONNECTION_ID, 'update', 'Account', testState.createdAccountId, // identifier
        ...
        const deleteResponse = await nangoService.triggerSalesforceAction('salesforce-2', config_1.CONFIG.CONNECTION_ID, 'delete', // This operation needs to be added to your service
        'Account', testState.createdAccountId // identifier
        );
