"use strict";
// src/services/conversation/prompts/dedicatedPlannerPrompt.ts
...
Your task is to analyze the user's request and the list of available tools, then create a structured execution plan.
...
2.  For each action:
    ...
    e.  Determine the "status":
        ...
        - "conditional": If any required parameters are missing.
...
Each action object must strictly follow this format:
{
  "id": "string",
  "intent": "string",
  "tool": "string",
