...
const markdown_stream_parser_1 = require("@lixpi/markdown-stream-parser"); // Added import
class FollowUpService extends events_1.EventEmitter {
    ...
    async handleFollowUp(request) {
        ...
        const followUpProcessingId = (0, uuid_1.v4)();
...
`;
            ...
            if (!parserSuccessfullyCleanedUp) {
                ...
                markdown_stream_parser_1.MarkdownStreamParser.removeInstance(parserInstanceId); // Remove instance regardless
            }
        }
    }
    /**
