...
export class PromptGeneratorService {
    ...
    private getBasePrompt(mode: Mode, query: string, entities: string[]): string {
        switch (mode) {
            case 'TARGETED':
    ...
    private buildTargetedPrompt(query: string, entities: string[]): string {
...
- Do NOT include any markdown or explanation outside the JSON`;
    ...
    private buildExploratoryPrompt(query: string): string {
...
- Do NOT include markdown or explanation outside JSON`;
    ...
    private buildAnalyticalPrompt(query: string): string {
...
- Do NOT include markdown or explanation outside JSON`;
    ...
    public generateEnrichmentPrompt(
        enrichment: 'cultural' | 'social' | 'visual',
        query: string,
        entities: string[],
    ): string {
