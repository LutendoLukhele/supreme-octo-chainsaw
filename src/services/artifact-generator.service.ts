// src/services/artifact-generator.service.ts
...
export class ArtifactGeneratorService {
    ...
    public async generateCodeArtifact(request: GenerateCodeRequest): Promise<Artifact> {
    ...
    public async generateAnalysisArtifact(request: GenerateAnalysisRequest): Promise<Artifact> {
    ...
    public async generateVisualizationArtifact(request: GenerateVisualizationRequest): Promise<Artifact> {
    ...
    private buildCodePrompt(prompt: string, language: string, context?: unknown): string {
...
- Return ONLY the code, no explanations`;
    ...
    private buildAnalysisPrompt(data: unknown, analysisType: string, context?: unknown): string {
...
Return ONLY the Python code, no explanations.`;
    ...
    private generateVisualizationTemplate(data: unknown, chartType: string, title: string): string {
...
`;
    ...
    private getChartCode(chartType: string): string {
        switch (chartType) {
            case 'bar':
